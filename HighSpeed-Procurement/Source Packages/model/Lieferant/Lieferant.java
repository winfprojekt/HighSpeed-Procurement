 ...
 * 
 * Adresse adresse = new Adresse(name,stra�eUndNummer,stadt,postleitzahl,land);
 ...
 * textfelder, ComboBox<String>[] comboBoxen){ //Textboxen,etc au�erhalb dieser
 ...
 * ComboBox<String>[] comboBoxen) { //Textboxen,etc au�erhalb dieser Funktion
 * als "new Array [] Textfeld textfelder" deklarieren
 * 
 * //... //Felder zuordnen
 * textfelder[0].setText(lieferant.getAdresse().getName());
 * textfelder[1].setText(lieferant.getAdresse().getStra�eUndNummer());
 ...
 * lieferant) { //Textboxen,etc au�erhalb dieser Funktion als
 ...
 * 
 * // einen Lieferant in der Datenbank �ndern public void update() {
 * 
 * }
 * 
 * //�berpr�fung der Nutzereingaben public String pflichtfelderAbfrage(TextField
 * [] textfelder) { //Leere R�ckgabe wenn alle Pflichtfelder ausgef�llt sind,
 * ansonsten string aus allen leeren Pflichtfeldern.
 * 
 * //Textboxen,etc au�erhalb dieser Funktion als
 ...
 * ", Stra�e und Nummer"; } if(!(textfelder[2].getText().equals(""))){
 ...
 * + Lieferbare dienstleistungen Pr�fen{ fehlercode +=
 ...
 * "Folgende Pflichtfelder wurden nicht ausgef�llt:"+
